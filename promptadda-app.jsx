...
function Tools({ tools }) {
  return (
    <section className="pa-section" id="tools">
      ...
      <p className="pa-tools-note">Some links are affiliate links — they keep PromptAdda free forever, at no cost to you.</p>
    </section>
  );
}
    ...
    <footer className="pa-footer">
      <div className="pa-footer-inner">
        <div className="pa-footer-brand">
          <div className="pa-logo"><span className="pa-logo-mark"><Icon name="spark" size={16} /></span> PromptAdda</div>
      ...
      <div className="pa-footer-bar">© 2026 PromptAdda · Copy, fill, paste, done.</div>
    </footer>
  );
}
